<template>
  <main>
    <div class="row wave-bg" id="about-section">
      <!-- HEADER SECTION -->
      <section id="header" class="col-md-12 text-center mb-4 mt-5">
        <h1 class="fw-bold">About Rick and Morty!</h1>
        <img src="../assets/img/drunk-rick.gif" class="mb-3 mt-5" />
      </section>

      <!-- ABOUT SECTION -->
      <section
        id="about-description"
        class="col-md-12 mt-5 text-center text-white background-pacific-blue"
      >
